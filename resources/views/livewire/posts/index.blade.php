    ...
    <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
        ...
        <div class="flex w-full p-3 space-x-2">
            ...
            <div class="w-3/6">
                ...
                <input wire:model.debounce.300ms='search' type="text" class="relative w-full px-3 py-3 pl-10 text-sm text-gray-700 placeholder-gray-400 bg-gray-100 border-none rounded shadow-inner outline-none focus:outline-none focus:shadow-outline focus:ring-0 focus:bg-indigo-100" placeholder="Пошук посту...">
            </div>
            ...
            <div class="relative w-1/6">
                <select wire:model='orderAsc' id="" class="relative w-full px-3 py-3 pl-10 text-sm text-gray-700 placeholder-gray-400 bg-gray-100 border-none rounded outline-none focus:outline-none focus:shadow-outline focus:ring-0 focus:bg-indigo-100">
                    <option value="1">&uarr;</option>
                    <option value="0">&darr;</option>
                </select>
            </div>
